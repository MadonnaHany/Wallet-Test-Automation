...
Mobile.tap(findTestObject('Shared Test Cases Objects/Payment Reciept Rating Page Objects/RateStatusField'), 0)

Mobile.tap(findTestObject('Shared Test Cases Objects/Payment Reciept Rating Page Objects/SimpleRating'), 0)

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Shared Test Cases Objects/Payment Reciept Rating Page Objects/Issue-Type'), GlobalVariable.TimeOut)
