...
//  5)
Mobile.clearText(findTestObject('Menu Tap Page Objects/My Favorites/Payment Page Objects/Cashout-Withdraw-Amount'), 0)
...
if (ExpectedMessage == 'Successful transaction') {
	...
	Mobile.tap(findTestObject('Menu Tap Page Objects/My Favorites/Payment Page Objects/CloseBtn'), GlobalVariable.TimeOuts)
}
