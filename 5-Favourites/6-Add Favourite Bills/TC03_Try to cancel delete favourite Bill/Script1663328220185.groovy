...
Mobile.tap(findTestObject('FavouriteBillsPageObjects/CancelBtn'), GlobalVariable.TimeOut)

Mobile.tap(findTestObject('FavouriteBillsPageObjects/CancelFavouriteDetailsPage'), 0)
