...
*/
//Mobile.verifyElementVisible(findTestObject('Menu Tap Page Objects/My Transactions Page Objects/MyTransactions Icon'), GlobalVariable.TimeOut)
...
Mobile.tap(findTestObject('Menu Tap Page Objects/My Transactions Page Objects/NotRatedLink'), 15)

Mobile.tap(findTestObject('Menu Tap Page Objects/My Transactions Page Objects/RateBar'), 5)

Mobile.tap(findTestObject('Menu Tap Page Objects/My Transactions Page Objects/describeIssueForRating'), 5)
...
Mobile.tap(findTestObject('Menu Tap Page Objects/My Transactions Page Objects/CloseConfirmRatingBar'), 0)
