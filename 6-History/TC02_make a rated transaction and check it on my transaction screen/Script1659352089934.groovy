...
WebUI.callTestCase(findTestCase('6-History/Making-Transaction with Rating(Vodafon Recharge)'), [('Phone') : '0120000200'], 
...
Mobile.verifyElementVisible(findTestObject('Recharge Page Objects/RateUs Page Objects/RateBar'), 0)
