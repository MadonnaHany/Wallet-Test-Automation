...
Mobile.setText(findTestObject('CashoutMainPageObjects/withdrawlAmountTxt'), '99999999999', 10)
...
Mobile.setText(findTestObject('CashoutMainPageObjects/mPinTxt'), '', 0)
...
Mobile.verifyElementText(findTestObject('CashoutMainPageObjects/reciptStatusMsg'), 'Declined transaction you have reached the daily maximum amount limit')
