...
Mobile.setText(findTestObject('CashoutMainPageObjects/withdrawlAmountTxt'), (AccountBalance - 30).toString(), 10)
...
//Mobile.verifyElementText(findTestObject('CashoutMainPageObjects/reciptStatusMsg'), 'Success')
