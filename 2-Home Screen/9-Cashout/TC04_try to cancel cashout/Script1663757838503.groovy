...
//CustomKeywords.'customkeywords.Keywords.selectSpecificElementFromWithinListWithBackwardsSwipe'(findTestObject('CashoutOtpPageObjects/NewTestCasesObjs/Home Screen Page Objects/btcsList-Fld'), 
//    'Cash Out')
...
//String permissionPopup=Mobile.verifyElementVisible(findTestObject('CashoutMainPageObjects/android.widget.FrameLayout_cashout_new'), GlobalVariable.TimeOut)
...
Mobile.tap(findTestObject('CashoutMainPageObjects/ButtonCancel_Review'), GlobalVariable.TimeOut)
...
{
	Mobile.verifyElementExist(findTestObject('CashoutMainPageObjects/confirmBtn'), GlobalVariable.TimeOut)
