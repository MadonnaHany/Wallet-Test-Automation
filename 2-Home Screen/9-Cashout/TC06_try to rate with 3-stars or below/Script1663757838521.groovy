...
////new
reviewMerchantNumber = Mobile.getText(findTestObject('CashoutMainPageObjects/MerchantNo_Reciept'),10)
////new
...
//Mobile.verifyElementText(findTestObject('CashoutMainPageObjects/withdrawlAmountErrorMessageTxt'), 'Please enter a valid value')
//new
//Mobile.pressBack()
