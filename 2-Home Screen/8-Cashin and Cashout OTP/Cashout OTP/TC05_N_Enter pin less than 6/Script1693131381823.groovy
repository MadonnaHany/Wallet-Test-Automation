...
Mobile.setText(findTestObject('Object Repository/CashoutOtpPageObjects/NewTestCasesObjs/TxtBox_PIN'), '147', GlobalVariable.TimeOut)

Mobile.tap(findTestObject('Object Repository/CashoutOtpPageObjects/NewTestCasesObjs/OKBtn_PINPopup'), GlobalVariable.TimeOut)
// verify error mssg is diplayed

Mobile.verifyElementVisible(findTestObject('Object Repository/CashoutOtpPageObjects/NewTestCasesObjs/android.widget.TextView - must consist of 6 numbers'),GlobalVariable.TimeOut)
