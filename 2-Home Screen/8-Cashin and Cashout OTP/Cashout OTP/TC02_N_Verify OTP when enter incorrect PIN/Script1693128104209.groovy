...
Mobile.setText(findTestObject('Object Repository/CashoutOtpPageObjects/NewTestCasesObjs/TxtBox_Amount'), '10',GlobalVariable.TimeOut)
...
Mobile.setText(findTestObject('Object Repository/CashoutOtpPageObjects/NewTestCasesObjs/TxtBox_PIN'), '123698', GlobalVariable.TimeOut)

Mobile.tap(findTestObject('Object Repository/CashoutOtpPageObjects/NewTestCasesObjs/OKBtn_PINPopup'), GlobalVariable.TimeOut)
// verify Error mssg is displayed

Mobile.verifyElementVisible(findTestObject('Object Repository/CashoutOtpPageObjects/NewTestCasesObjs/android.widget.TextView - Invalid mobile number or pin'),GlobalVariable.TimeOut)

Mobile.tap(findTestObject('Object Repository/CashoutOtpPageObjects/NewTestCasesObjs/OKBtn_ErrorMsg'), GlobalVariable.TimeOut)
