...
// new line
 ...
 continueBtnEnabled=Mobile.getAttribute(findTestObject('CashoutMainPageObjects/ContinuBtn'), 'enabled', 10)
...
if(continueBtnEnabled)
	...
	Mobile.verifyEqual(message.contains(ErrorMssg)||message.contains(mismatchErr).concat('.') , true, FailureHandling.CONTINUE_ON_FAILURE)
	Mobile.pressBack()
