...
//Mobile.setText(findTestObject('CashoutMainPageObjects/withdrawlAmountTxt'), '6000', 10)
...
String TransactionStatus = Mobile.getText(findTestObject('Shared Test Cases Objects/Invalid M-PIN Page Objects/Transaction_receipt_status'),10)


Mobile.verifyEqual(TransactionStatus.contains(InsuffecientFunds)||TransactionStatus.contains(ExceededMssg)||TransactionStatus.contains(ExceededAmountOtherMssg),true, FailureHandling.CONTINUE_ON_FAILURE)


//Mobile.verifyEqual(Mobile.getText(findTestObject('Shared Test Cases Objects/Invalid M-PIN Page Objects/Transaction_receipt_status'),
//	GlobalVariable.TimeOut).toString(), ExceededMssg, FailureHandling.CONTINUE_ON_FAILURE)
