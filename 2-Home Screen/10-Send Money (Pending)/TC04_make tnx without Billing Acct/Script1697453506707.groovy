...
try
{
  Mobile.setText(findTestObject('Recharge Page Objects/Payment Page Objects/mobileNumber'), '  ', GlobalVariable.TimeOut)
}
...
Mobile.setText(findTestObject('Recharge Page Objects/Payment Page Objects/MobileNumberConfirmTextBox'), ' ',
...
Mobile.setText(findTestObject('CashoutMainPageObjects/withdrawlAmountTxt'), '10', GlobalVariable.TimeOut)
...
if (continueBtnEnabled=='true')
	{
	   ...
	   Mobile.verifyEqual(errorMsg.contains(EmptyMobile), true, FailureHandling.CONTINUE_ON_FAILURE)
	}
