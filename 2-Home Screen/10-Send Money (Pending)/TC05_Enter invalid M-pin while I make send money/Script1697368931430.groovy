...
Mobile.setText(findTestObject('CashoutMainPageObjects/mPinTxt'), InvalidPin, GlobalVariable.TimeOut)
...
// set configuration to be allowed only one trial for entering incorrect pin
try {
