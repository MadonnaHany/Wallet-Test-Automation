...
//Consider There Is ONLY ONE TRIAL TO MAKE TRNX
double CurrentBalance
CurrentBalance=CustomKeywords.'db_operations.MyWalletDBOperations.GetBalance'(GlobalVariable.MobileNumber)
...
Mobile.setText(findTestObject('CashoutMainPageObjects/withdrawlAmountTxt'), (CurrentBalance+1).toString(), GlobalVariable.TimeOut)
