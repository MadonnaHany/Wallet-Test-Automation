...
Mobile.setText(findTestObject('Recharge Page Objects/Payment Page Objects/MobileNumberConfirmTextBox'), '01001111111',
...
Mobile.setText(findTestObject('CashoutMainPageObjects/withdrawlAmountTxt'),'20', GlobalVariable.TimeOut)
...
if (continueBtnEnabled=='true')
	{
	   ...
	   mismatchError = Mobile.getText(findTestObject('Recharge Page Objects/Payment Page Objects/MismatchMobileError'), 10)
	   
	   // new
	   Mobile.verifyEqual(mismatchError.contains(MismatchError), true, FailureHandling.CONTINUE_ON_FAILURE)
