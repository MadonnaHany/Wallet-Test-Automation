...
try {
	...
	Mobile.setText(findTestObject('Recharge Page Objects/Payment Page Objects/mobileNumber'), GlobalVariable.MobileNumber, GlobalVariable.TimeOut)
}
...
Mobile.setText(findTestObject('Recharge Page Objects/Payment Page Objects/MobileNumberConfirmTextBox'),  GlobalVariable.MobileNumber,
...
try {
	...
	Mobile.verifyElementVisible(findTestObject('Object Repository/send Money/ErrorMsg_sendToYourSelf'),GlobalVariable.TimeOut)
 }
catch(Exception ex)
{
